...
if ($ADMIN->fulltree) {
    $name = 'block_content_templates/templatecategory';
    $title = get_string('templatecategory', 'block_content_templates');
    $description = get_string('templatecategory_desc', 'block_content_templates');
    $default = "Templates";
    ...
    $template_cat_id = get_config('block_content_templates', 'templatecategory');
    if(isset($template_cat_id) && $template_cat_id > 0){
        $name = 'block_content_templates/defaulttemplate';
        $title = get_string('defaulttemplate', 'block_content_templates');
        $description = get_string('defaulttemplate_desc', 'block_content_templates');
        $default = 0;
